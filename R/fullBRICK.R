...
fullBRICK <- function(rev = 0, granularity = NULL) {
  ...
  calcOutput("LifetimeParams", subtype = "building",      granularity = granularity, file = "f_lifetimeBuilding.cs4r")
  calcOutput("LifetimeParams", subtype = "heatingSystem", granularity = granularity, file = "f_lifetimeHeatingSystem.cs4r")
