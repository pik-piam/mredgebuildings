...
R package **mredgebuildings**, version **0.11.0**
...
Hasse R, Sauer P, Levesque A, Tockhorn H (2025). "mredgebuildings: Prepare data to be used by the EDGE-Buildings model." Version: 0.11.0, <https://github.com/pik-piam/mredgebuildings>.
